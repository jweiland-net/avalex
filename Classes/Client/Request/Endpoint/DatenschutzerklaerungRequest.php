 ...
 */
final readonly class DatenschutzerklaerungRequest implements RequestInterface, DomainRequestInterface, LocalizeableRequestInterface
{
    use RequestTrait;
     ...
     */
    private const ENDPOINT = 'avx-datenschutzerklaerung';
